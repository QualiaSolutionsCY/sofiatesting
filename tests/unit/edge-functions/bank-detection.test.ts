...
describe("bank-detection", () => {
  describe("detectBankFromUrl", () => {
    ...
    it("detects REMU from remuproperties.com", () => {
      expect(detectBankFromUrl("https://remuproperties.com/property/123")).toBe(
        "REMU"
      );
    ...
    it("detects Altamira from altamira-amc.com", () => {
      expect(detectBankFromUrl("https://altamira-amc.com/property/456")).toBe(
        "Altamira"
      );
    ...
    it("detects Altamira from altamira-npl.com", () => {
      expect(detectBankFromUrl("https://altamira-npl.com/listings")).toBe(
        "Altamira"
      );
    ...
    it("detects Gordian from gogordian.com", () => {
      expect(detectBankFromUrl("https://gogordian.com/property/789")).toBe(
        "Gordian"
      );
    ...
    it("detects Gordian from gordian.com.cy", () => {
      expect(detectBankFromUrl("https://gordian.com.cy/listings")).toBe(
        "Gordian"
      );
    ...
    it("detects Bank of Cyprus from bankofcyprus.com", () => {
      expect(detectBankFromUrl("https://bankofcyprus.com/property/321")).toBe(
        "Bank of Cyprus"
      );
    ...
    it("detects Bank of Cyprus from boc.com.cy", () => {
      expect(detectBankFromUrl("https://boc.com.cy/listings")).toBe(
        "Bank of Cyprus"
      );
    ...
    it("detects Hellenic Bank from hellenic-bank.com", () => {
      expect(detectBankFromUrl("https://hellenic-bank.com/property/654")).toBe(
        "Hellenic Bank"
      );
    ...
    it("detects Hellenic Bank from hellenicbank.com", () => {
      expect(detectBankFromUrl("https://hellenicbank.com/listings")).toBe(
        "Hellenic Bank"
      );
    ...
    it("detects banks from full URLs with paths", () => {
      expect(
        detectBankFromUrl("https://www.remuproperties.com/property/123?ref=abc")
      ).toBe("REMU");
      expect(
        detectBankFromUrl(
          "https://www.altamira-amc.com/en/property/456#details"
        )
      ).toBe("Altamira");
    });
  ...
  describe("isBankPropertyUrl", () => {
    it("returns true for bank URLs", () => {
      expect(isBankPropertyUrl("https://remuproperties.com/property/123")).toBe(
        true
      );
