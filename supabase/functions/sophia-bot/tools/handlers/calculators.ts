 ...
 */
export function handleCalculateTransferFees(args: Record<string, unknown>): ToolResult {
  const price = args.price as number;
 ...
 */
export function handleCalculateCapitalGains(args: Record<string, unknown>): ToolResult {
