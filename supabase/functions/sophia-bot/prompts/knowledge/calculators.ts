 ...
 *
 * SOURCE: DB key 'calculators' (this file is FALLBACK only)
 *
 * This file is used ONLY when:
 * 1. Database is unavailable
 * 2. The 'calculators' key is missing from sophia_prompts table
 *
 * To edit in production:
 * 1. Edit in Supabase Dashboard: sophia_prompts WHERE key = 'calculators'
