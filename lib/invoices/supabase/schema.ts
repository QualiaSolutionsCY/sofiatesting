...
export const VAT_MODE_VALUES = [
  "plus-vat",
  "included-vat",
  "no-vat",
] as const satisfies readonly VatMode[];
export const STORAGE_STATUS_VALUES = [
  "not-generated",
  "stored",
  "needs-regeneration",
] as const satisfies readonly StorageStatus[];
export const WHATSAPP_STATUS_VALUES = [
  "planned",
  "queued",
  "sent",
  "blocked",
] as const satisfies readonly WhatsappStatus[];
...
export const WEBHOOK_SIGNATURE_STATUS_VALUES = [
  "not-required",
  "unverified",
  "verified",
  "failed",
