...
export type IntegrationProvider = TupleValue<
  typeof INTEGRATION_PROVIDER_VALUES
>;
export type DeliveryQueueStatus = TupleValue<typeof ACTION_QUEUE_STATUS_VALUES>;
export type DeliveryEventStatus = TupleValue<
  typeof DELIVERY_EVENT_STATUS_VALUES
>;
export type WebhookSignatureStatus = TupleValue<
  typeof WEBHOOK_SIGNATURE_STATUS_VALUES
>;
export type WebhookProcessingStatus = TupleValue<
  typeof WEBHOOK_PROCESSING_STATUS_VALUES
>;
